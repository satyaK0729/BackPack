...
public class CheckList extends AppCompatActivity {
    ...
    public boolean onCreatePanelMenu(int featureId, @NonNull Menu menu) {
        ...
        //iti applicabel for only MYSELECTions it shows on index 0,2,3
        ...
        MenuItem menuItem = menu.findItem(R.id.btnMySearch);
    ...
    //Giving functionality to the options in the top right three dots.
    @Override
        ...
        switch (item.getItemId()) {
            ...
            case R.id.btnDeleteDefault:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are you sure?\n\nAs this will delete the data provided by (BackPack App) while installing")
                        .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                appData.persistDataByCategory(header, true);
                                itemsList = database.mainDao().getAll(header); // Update the itemsList after deleting default data
                                updateRecycler(itemsList);
                            }
            ...
            case R.id.btnReset:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are you sure?\n\nAs this will load the default data provided by (BackPack App) and will delete the custom data you have added in ( "+header+" )")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);  //this keep the back arrow on the top left
        ...
        //Time : 2:18:30
        //Conditions for what to show and what not to show
        ...
        updateRecycler(itemsList);  //this will show the list of items on the screen
    ...
    //Giving functionality to the back arrow on the top left
    @Override
    ...
    //I guess used to update the contents on the screen when an item is added
